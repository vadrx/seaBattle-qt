...
void MyPoint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyPoint::signal1)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyPoint::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyPoint.data,
      qt_meta_data_MyPoint,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyPoint::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< MyPoint*>(this));
